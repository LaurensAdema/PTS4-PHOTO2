...
public class MyOrdersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int accountID = -1;
        if (request.getParameter("id") != null && account != null && request.getParameter("all") == null) {
            try {
            ...
            try {
                ...
                ResultSet results = Database.getDatabase().query("SELECT * FROM ordera WHERE id = " + request.getParameter("id"), Database.QUERY.QUERY);
