...
public class EditPhotoOnMug extends HttpServlet {
        ...
        try {
            ...
            while (fileItemsIterator2.hasNext()) {
                ...
                try {
                    ...
                    BufferedImage dimg = new BufferedImage(400, 400, Image.SCALE_SMOOTH);
                 ...
                 // iemand heeft dit ooit gedaan(ipv van bovenste lijn)? : File file2 = new File(request.getServletContext().getAttribute("FILES_DIR") + File.separator + "\\Low resolution\\" + fileItem.getName().split(".")[0].split("\\")[1] + ".jpg");
                    ...
                    out.write("<img src=\"UploadDownloadFileServlet?fileName=Low resolution\\"+fileItem.getName()+"\"    style=\"position:relative; top:0; left:0;\"/>");
                    out.write("<img src=\"UploadDownloadFileServlet?fileName=Low resolution\\"+fileItem.getName()+"\" width=\"200\" height=\"40\" style=\"position:absolute; top:30; left:70;\"/>");
...
//</div>
                   ...
                   out.write("<img src=\"UploadDownloadFileServlet?fileName=Low resolution\\"+fileItem.getName()+"\">");
